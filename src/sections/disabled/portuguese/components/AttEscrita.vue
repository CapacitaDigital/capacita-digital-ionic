...
import Options from "reasoning/components/Options.vue";
import { speakText , speek } from 'portuguese/services/fala';
import Modal from "technology/components/Modal.vue";
